...
# ADD LINK32 user32.lib /nologo /subsystem:windows /dll /machine:I386 /out:"..\Distribution\TestDLL.dll"
...
# ADD LINK32 user32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\Distribution\TestDLL.dll" /pdbtype:sept
